...
`;
    ...
    const styles='<link rel="stylesheet" href="screen-fit.css?v=2"><link rel="stylesheet" href="theme-modern.css?v=7"><link rel="stylesheet" href="course-ui-enhancements.css?v=1&django=1"><link rel="stylesheet" href="primary-area-ui.css?v=4&db=1&ts=1&tools=1"><link rel="stylesheet" href="global-interactive-code-editor.css?v=1">';
    ...
    const scripts=[
      ...
      'css-section.js?v=4','css-div-layout-section.js?v=1','css-div-center-screen-enhancer.js?v=1','css-pseudo-classes-section.js?v=1','css-visual-property-sections.js?v=1','css-guided-challenges.js?v=4','css-games-section.js?v=15','css-frameworks-section.js?v=4','ui-ux-tools-section.js?v=1','ui-ux-visual-styles-section.js?v=1','course-ux-form-keyboard.js?v=1','course-ux-form-errors.js?v=1','course-ux-form-project.js?v=1',
      'javascript-section.js?v=3','javascript-reduce-some-every-section.js?v=1','javascript-foundations-extra-1.js?v=1','javascript-script-loading-enhancer.js?v=1','javascript-foundations-extra-2.js?v=1','javascript-runtime-review.js?v=1','javascript-functions-detailed.js?v=1','dom-section.js?v=2','dom-selectors-section.js?v=1','javascript-fetch-api-detailed.js?v=3','javascript-publicapis-practice.js?v=3','javascript-json-files-section.js?v=1','javascript-json-database-section.js?v=1','javascript-authenticated-apis-igdb-section.js?v=1','javascript-browser-apis-no-node-section.js?v=1','cheat-sheets-section.js?v=1','visual-reference-expansion.js?v=1','api-json-cheat-sheet.js?v=1','api-json-html-js-section.js?v=1','public-api-json-practice.js?v=1','free-apis-section.js?v=1','api-auth-jwt-cookies-sessions.js?v=1','web-security-state-data-section.js?v=1','api-html-css-basic-section.js?v=1','api-documentation-openapi-section.js?v=1','http-status-codes-section.js?v=1',
