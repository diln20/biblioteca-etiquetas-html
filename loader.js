...
`;
    ...
    const styles='<link rel="stylesheet" href="screen-fit.css?v=2"><link rel="stylesheet" href="theme-modern.css?v=7"><link rel="stylesheet" href="course-ui-enhancements.css?v=1&django=1"><link rel="stylesheet" href="primary-area-ui.css?v=4&db=1&ts=1&tools=1">';
    ...
    const scripts=[
      ...
      'css-section.js?v=4','css-div-layout-section.js?v=1','css-div-center-screen-enhancer.js?v=1','css-pseudo-classes-section.js?v=1','css-guided-challenges.js?v=4','css-games-section.js?v=15','css-frameworks-section.js?v=4','ui-ux-tools-section.js?v=1','ui-ux-visual-styles-section.js?v=1','course-ux-form-keyboard.js?v=1','course-ux-form-errors.js?v=1','course-ux-form-project.js?v=1',
