...
`;
    ...
    const scripts=[
      ...
      'javascript-section.js?v=3','javascript-foundations-extra-1.js?v=1','javascript-script-loading-enhancer.js?v=1','javascript-foundations-extra-2.js?v=1','javascript-runtime-review.js?v=1','javascript-functions-detailed.js?v=1','dom-section.js?v=2','dom-selectors-section.js?v=1','javascript-fetch-api-detailed.js?v=1','free-apis-section.js?v=1','api-auth-jwt-cookies-sessions.js?v=1','web-security-state-data-section.js?v=1','api-html-css-basic-section.js?v=1',
