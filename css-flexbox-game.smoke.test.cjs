...
assert.ok(html.includes('css-flexbox-game.css?v=1'));
assert.ok(html.includes('css-flexbox-game.js?v=1'));
...
assert.ok(section.includes('css-flexbox-game.html'),'la sección debe enlazar Flexbox Arena');
