...
`;
    ...
    const scripts=[
      ...
      'section-order.js?v=7&htmlorder=2','framework-category-guide.js?v=1','web-security-state-data-finalizer.js?v=1','modern-frontend-tools-section.js?v=1','backend-category-guide.js?v=1','django-framework-category-guide.js?v=1','django-framework-js-guide.js?v=1','database-from-zero-section.js?v=1','database-category-guide.js?v=2','typescript-course-section.js?v=1','typescript-category-finalizer.js?v=1','vscode-snippet-placeholders.js?v=1','vscode-tools-section.js?v=1','dev-tools-category-finalizer.js?v=1','dev-tools-exercises.js?v=1','css-property-explanations.js?v=3','example-code-formatter.js?v=1','explanation-enhancer.js?v=9','exact-explanation-enhancer.js?v=1','html-order-finalizer.js?v=1','course-ui.js?v=15','file-guide-ui.js?v=2&frameworks=3&db=1&tools=1','personalized-exercises.js?v=1','primary-area-ui.js?v=3&htmlorder=2&tools=1'
    ];
