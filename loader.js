...
`;
    ...
    const scripts=[
      ...
      'framework-projects-section.js?v=3','angular-category-finalizer.js?v=1','angular-file-guide-corrections.js?v=3','course-backend-scaling-basics.js?v=1','course-backend-scaling-architecture.js?v=1','course-backend-scaling-resilience.js?v=1',
