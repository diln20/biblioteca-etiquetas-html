...
`;
    ...
    const scripts=[
      ...
      'frontend-frameworks-section.js?v=4','angular-from-zero-section.js?v=2','angular-overview-section.js?v=1','angular-beginner-environment.js?v=1','course-angular-components.js?v=1','course-angular-bindings.js?v=1','angular-beginner-signals.js?v=1','course-angular-forms.js?v=1',
      ...
      'framework-projects-section.js?v=3','angular-category-finalizer.js?v=1','angular-file-guide-corrections.js?v=5','angular-required-files.js?v=1','course-backend-scaling-basics.js?v=1','course-backend-scaling-architecture.js?v=1','course-backend-scaling-resilience.js?v=1',
