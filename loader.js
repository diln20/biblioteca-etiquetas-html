...
`;
    ...
    const scripts=[
      'attribute-examples.js?v=6','learning-visuals.js?v=1','web-foundations-section.js?v=2','html-practice-section.js?v=1','html-input-types-section.js?v=1','html-input-attribute-explanations.js?v=1',
